# Pest.Co — تطبيق CRM
تطبيق React لتسجيل العملاء ومتابعة مواعيد الاتصال بهم، بتسجيل دخول بالبريد الإلكتروني وحفظ سحابي عبر Firebase — يعني بياناتك بتتزامن من أي جهاز تدخل بيه بنفس الحساب.
