// ============================================================================
// Customer detail screen, extracted from App.jsx.
//
// Presentational only. Every Firestore call, validation, and piece of state
// (active customer, offers, activity log, etc.) still lives in App.jsx and
// is passed down as props/handlers — nothing about how data is read or
// written changed, only where the JSX that renders it lives.
// ============================================================================
