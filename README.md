...
نظام CRM مبني بـ React لتسجيل زيارات العملاء ومتابعة مواعيد الاتصال بهم، بتسجيل دخول بالبريد الإلكتروني وحفظ سحابي عبر Firebase — يعني بياناتك بتتزامن من أي جهاز تدخل بيه بنفس الحساب.
...
└── src/
    ...
    ├── geo.js                   # التقاط موقع GPS وقت تسجيل الزيارة + رابط خرائط جوجل
    ├── pdfReport.js              # توليد تقرير PDF من بيانات الداشبورد
